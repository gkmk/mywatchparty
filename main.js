class MyWatchParty {
    ...
    static mainScreenClass = "main-screen max-h-full max-w-full overflow-hidden order-first bg-black row-span-5 col-span-4 aspect-video p-2 outline-slate-700 outline-double rounded shadow-lg";
